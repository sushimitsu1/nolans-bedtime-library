...
4. Generate the cover separately, then Pages 1-9 as individual illustration-only images.
...
Never use old artwork as a substitute, infer missing pages, request multi-page images, modify unrelated stories, or bypass a failed validation.
