...
narration: [
  "Towie the tow truck loved helping on Cozy Corner Road. Every evening, he took one gentle drive before bed.",
  "Tonight, the sky was peach and pink. Towie spotted Willow the little van near Pebble Lane.",
  "Willow gave a tiny honk. One of her wheels was stuck in a soft muddy patch.",
  "At the bend near Cozy Corner, Towie heard a tiny call. A little van named Willow was stuck in the mud.",
  "Towie checked the muddy wheel very carefully. “We will make a safe plan first,” he said kindly.",
  "Towie brought out his soft tow strap. Willow took a deep breath and stayed nice and calm.",
  "Slowly and gently, Towie hooked the strap in place. “Ready, Willow?” he asked with a smile.",
  "Towie pulled very softly. Pop! Willow rolled free from the mud.",
  "With one careful pull, Willow rolled free. ‘Thank you, Towie!’ she said with a happy beep.",
  "Towie towed Willow slowly through the village. They made sure the ride was smooth and safe.",
  "They rolled together toward Cozy Corner. The evening felt safe and calm again.",
  "At the garage, the friends took a deep breath. Everything was back where it should be.",
  "The friends cheered for Willow and Towie. Helping each other had made the day special.",
  "Soon the sky grew sleepy and blue. Towie and Willow waved a gentle good night.",
  "Towie parked for bed with a happy heart. Helping a friend made the best ending of all."
]
},
{
