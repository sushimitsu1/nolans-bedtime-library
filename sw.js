const CACHE='nolan-library-v38';
const CORE=['./','index.html','styles.css','app.js','config/narration-voices.json','manifest.webmanifest','assets/icons/icon-192.png','assets/icons/icon-512.png'];
